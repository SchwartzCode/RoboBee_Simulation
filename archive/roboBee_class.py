...
class roboBee(object):
    ...
    ROTATION_MIN = 0.000000000001 #minimum angle of rotation required for robot orientaiton to be changed [radians]
    ...
    def update_accels(self):
        ...
        self.angular_accel = ((torque_gen - drag_torque + np.cross(self.R_w, drag_force)
