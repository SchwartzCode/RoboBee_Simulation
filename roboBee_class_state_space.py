...
class roboBee(object):
    ...
    def updateState(self, state, dt):
        ...
        torque_constant_prop = 5e-9
        torque_constant_deriv = 1.4e-7
    ...
    def run(self, timesteps):
        ...
        for i in range(timesteps):
            ...
            half_state = self.updateState(state.copy(), self.dt/2)
            state = self.updateState(half_state, self.dt)
